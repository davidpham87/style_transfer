...
class AdaINModel(object):
    ...
    def build_decoder(self, input_shape):
        ...
        Conv2DReflectCurry = lambda c: Conv2DReflect(c, 3, padding='valid', activation='relu')

        arch = [                                                        #  HxW  / InC->OutC
            Conv2DReflectCurry(256),                                    # 32x32 / 512->256
            UpSampling2D(),
            Conv2DReflectCurry(256),                                    # 64x64 / 256->256
            Conv2DReflectCurry(256),                                    # 64x64 / 256->256
            Conv2DReflectCurry(256),                                    # 64x64 / 256->256
            Conv2DReflectCurry(256),                                    # 64x64 / 256->256
            Conv2DReflectCurry(128),                                    # 64x64 / 256->128
            UpSampling2D(),                                             # 64x64 -> 128x128
            Conv2DReflectCurry(128),                                    # 128x128 / 128->128
            Conv2DReflectCurry(64),                                     # 128x128 / 128->64
            Conv2DReflectCurry(64),                                     # 128x128 / 64->64
            UpSampling2D(),                                             # 128x128 -> 256x256
            Conv2DReflectCurry(64),                                     # 256x256 / 64->64
